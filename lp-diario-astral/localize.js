(function () {
  ...
  var v2 = [
    ...
    ['200 milhões de pessoas.', '200 millones de personas.'],
    ['🌙 Um é para ', '🌙 Uno es para '],
    ['200 milhões', '200 millones'],
    ['. O outro é ', '. El otro es '],
    ['só seu.', 'solo tuyo.'],
    ['O horóscopo genérico não conhece a sua história. No Diário Astral, os trânsitos de cada dia são lidos sobre o seu mapa natal, e calculado com a sua data, hora e cidade de nascimento.', 'El horóscopo genérico no conoce tu historia. En el Diario Astral, los tránsitos de cada día se leen sobre tu carta natal, calculada con tu fecha, hora y ciudad de nacimiento.'],
    ['Você recebe uma leitura nova, escrita só para você.', 'Recibís una lectura nueva, escrita solo para vos.'],
