...
export const PRODUCTS = Object.freeze({
  DIARIO_ASTRAL: "site:diario_astral",
  ...
  DIARIO_ASTRAL_COMPLETO: "site:diario_astral_completo",
  ...
  COMBO_DIARIO_ASTRAL_MAPA_ASTRAL: "site:combo_diario_astral_mapa_astral",
  COMBO_DIARIO_ASTRAL_MAPA_AMOR: "site:combo_diario_astral_mapa_amor",
  COMBO_DIARIO_ASTRAL_MAPA_PROSPERIDADE: "site:combo_diario_astral_mapa_prosperidade",
});
...
export const SITE_CATALOG = Object.freeze([
  product(
    ...
    // 30 dias de acesso — sem cobrança automática.
  ...
  product(
    PRODUCTS.DIARIO_ASTRAL_COMPLETO,
    "diario-astral-completo",
    "Diário Astral Completo",
    "offer",
    "Um mês de Diário Astral com todos os bônus de leitura.",
    [
      CONTENT.HOROSCOPE_DAILY,
      CONTENT.MONTHLY_GUIDE,
      CONTENT.ASTRAL_MAP,
  ...
  product(
    PRODUCTS.COMBO_DIARIO_ASTRAL_MAPA_ASTRAL,
    "combo-diario-astral-mapa-astral",
    "Diário Astral + Mapa Astral",
    "combo",
    "Acompanhamento diário e seu mapa completo em uma só compra.",
    [CONTENT.HOROSCOPE_DAILY, CONTENT.MONTHLY_GUIDE, CONTENT.ASTRAL_MAP],
    { includes: [PRODUCTS.DIARIO_ASTRAL, PRODUCTS.MAPA_ASTRAL] },
  ),
  product(
    PRODUCTS.COMBO_DIARIO_ASTRAL_MAPA_AMOR,
    "combo-diario-astral-mapa-amor",
    "Diário Astral + Mapa do Amor",
    "combo",
    ...
    { includes: [PRODUCTS.DIARIO_ASTRAL, PRODUCTS.MAPA_AMOR] },
  ),
  product(
    PRODUCTS.COMBO_DIARIO_ASTRAL_MAPA_PROSPERIDADE,
    "combo-diario-astral-mapa-prosperidade",
    "Diário Astral + Mapa da Prosperidade",
    "combo",
    ...
    { includes: [PRODUCTS.DIARIO_ASTRAL, PRODUCTS.MAPA_PROSPERIDADE] },
  ),
]);
