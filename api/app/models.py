...
class Profile(Base):
    ...
    birth_state: Mapped[str | None] = mapped_column(String(64), nullable=True, default=None)
    ...
    partner_birth_state: Mapped[str | None] = mapped_column(String(64), nullable=True, default=None)
